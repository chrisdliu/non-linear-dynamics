...
class JuliaWindow(pyg.window.Window):
    def set_vars(self):
        ...
        self.valset.add_num_value('max_iter', 24)
        self.valset.add_num_value('limit', 20.0)
        self.valset.add_num_value('c', -.25 -.67j)
        self.valset.add_num_value('calctime', 0.0)
        self.valset.add_num_value('flushtime', 0.0)
        self.valset.add_num_value('palette0r', 0)
        self.valset.add_num_value('palette0g', 0)
        self.valset.add_num_value('palette0b', 0)
        self.valset.add_num_value('palette1r', 100)
        self.valset.add_num_value('palette1g', 0)
        self.valset.add_num_value('palette1b', 100)
        self.valset.add_num_value('palette2r', 255 )
        self.valset.add_num_value('palette2g', 255)
        self.valset.add_num_value('palette2b', 255)
        self.valset.add_num_value('palette3r', 255)
        self.valset.add_num_value('palette3g', 161)
        self.valset.add_num_value('palette3b', 3)
        self.valset.add_bool_value('mouse_c', False)

        main = JuliaScreen(0, 300, 500, 500, valset=self.valset)
        self.add_screen('main', main)

        self.add_float_field('zoomfield', 120, 30, 120, 15, 'Zoom', self.get_valobj('sz'), limit='ul', inclusive='', low=0, high=1)
        self.add_int_field('max_iter', 120, 180, 120, 15, 'Max Iter', self.get_valobj('max_iter'), limit='l', low=1)
        self.add_float_field('limit', 120, 160, 120, 15, 'Limit', self.get_valobj('limit'), limit='l', inclusive='', low=0)
